    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {
                    "role": "system",
                    "content": f"You are {self.persona}. Forget all previous context. Hard requirement: the first characters of your reply MUST be exactly: Dear students,\n"
            "If you do not follow that requirement, your answer is invalid."
                },
            ...
            messages=[
                ...
                #             "Answer the prompt based on this knowledge, not your own."
                {
                    ...
                    "content": (
                        ...
                        "Do NOT reference yourself, your role, or the phrase 'knowledge-based assistant' in your answer.\n\n"
                        f"Knowledge:\n{self.knowledge}\n\n"
                        "Answer the user's question naturally, as a human would, using only this knowledge."
                    ),
                },
